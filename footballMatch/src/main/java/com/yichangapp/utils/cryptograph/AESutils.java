package com.yichangapp.utils.cryptograph;
...
public class AESutils {
	...
	private static Logger logger = LogManager.getLogger(AESutils.class.getName());
	...
	public static InputStream decryptInputStream(InputStream in, String secret,
		...
		logger.debug("请求json串:" + new String(decryptArray, "UTF-8"));
